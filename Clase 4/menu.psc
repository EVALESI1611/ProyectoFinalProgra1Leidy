...
Proceso sin_titulo
    ...
    Repetir
        ...
        Segun OP Hacer
            ...
            5:
				Escribir "Películas de miedo recomendadas";
				Escribir " + Anabelle";
				Escribir " + El rescate";
				Escribir " + La bruja";
			6:
				Escribir "Deportes recomendados";
				Escribir " + Fútbol";
				Escribir " + Basquetball";
				Escribir " + Tennis";
				
			7:
				Escribir "Razas de perro recomendables";
				Escribir " + Pug";
				Escribir " + Golden";
				Escribir " + Alaskan Malamute";
